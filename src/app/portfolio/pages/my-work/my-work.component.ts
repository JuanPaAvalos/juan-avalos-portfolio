...
export class MyWorkComponent {
  public projects: Project[] = [
    ...
    },
    {
      ...
      description: 'Aplicación web hecha con PrimeNg que sirve como demostración del uso de diferentes tipos de pipes asi como la creación de pipes personalizados',
    ...
    },
    {
      ...
      description: 'CRUD de héroes hecho con ángular material, cuenta con un backend local gracias a la librería de json-server además de un login que aprovecha los guards para proteger el acceso y el uso de diferentes módulos para las secciones del login y el CRUD',
      githubLink: 'https://github.com/JuanPaAvalos/GifsApp',
    },
    {
      name: 'Forms App',
